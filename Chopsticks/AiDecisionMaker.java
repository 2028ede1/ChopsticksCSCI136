...
public class AiDecisionMaker implements MinimaxTree<OurGameState> {
	...
	/**
     * Constructs a new AiDecisionMaker object with 
	...
	public static void main(String[] args) {
		AiDecisionMaker testAi = new AiDecisionMaker();
